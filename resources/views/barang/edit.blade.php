                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('stok_total') is-invalid @enderror" 
                               id="stok_total" name="stok_total" value="{{ old('stok_total', $barang->stok_total) }}" min="1" required>
                        @error('stok_total')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('harga_sewa_per_hari') is-invalid @enderror" 
                                   ...
                                   value="{{ old('harga_sewa_per_hari', $barang->harga_sewa_per_hari) }}" min="0" required>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('denda_per_hari') is-invalid @enderror" 
                                   id="denda_per_hari" name="denda_per_hari" 
                                   value="{{ old('denda_per_hari', $barang->denda_per_hari) }}" min="0" required>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            ...
                            <option value="non_aktif" {{ old('status', $barang->status) == 'non_aktif' ? 'selected' : '' }}>Non Aktif</option>
                        </select>
                    </div>
